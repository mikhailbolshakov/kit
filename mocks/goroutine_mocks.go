...
func (_mock *GoroutineErrGroup) WithLogger(logger kit.CLogger) goroutine.ErrGroup {
	...
	var r0 goroutine.ErrGroup
	if returnFunc, ok := ret.Get(0).(func(kit.CLogger) goroutine.ErrGroup); ok {
...
func (_c *GoroutineErrGroup_WithLogger_Call) Run(run func(logger kit.CLogger)) *GoroutineErrGroup_WithLogger_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(kit.CLogger))
	})
	return _c
}
...
func (_c *GoroutineErrGroup_WithLogger_Call) RunAndReturn(run func(logger kit.CLogger) goroutine.ErrGroup) *GoroutineErrGroup_WithLogger_Call {
	_c.Call.Return(run)
	return _c
}

// WithLoggerFn provides a mock function for the type GoroutineErrGroup
func (_mock *GoroutineErrGroup) WithLoggerFn(loggerFn kit.CLoggerFunc) goroutine.ErrGroup {
	...
	var r0 goroutine.ErrGroup
	if returnFunc, ok := ret.Get(0).(func(kit.CLoggerFunc) goroutine.ErrGroup); ok {
...
func (_c *GoroutineErrGroup_WithLoggerFn_Call) Run(run func(loggerFn kit.CLoggerFunc)) *GoroutineErrGroup_WithLoggerFn_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(kit.CLoggerFunc))
	})
	return _c
}
...
func (_c *GoroutineErrGroup_WithLoggerFn_Call) RunAndReturn(run func(loggerFn kit.CLoggerFunc) goroutine.ErrGroup) *GoroutineErrGroup_WithLoggerFn_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *GoroutineGoroutine) WithLogger(logger kit.CLogger) goroutine.Goroutine {
	ret := _mock.Called(logger)
	...
	var r0 goroutine.Goroutine
	if returnFunc, ok := ret.Get(0).(func(kit.CLogger) goroutine.Goroutine); ok {
		r0 = returnFunc(logger)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(goroutine.Goroutine)
...
func (_c *GoroutineGoroutine_WithLogger_Call) Run(run func(logger kit.CLogger)) *GoroutineGoroutine_WithLogger_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(kit.CLogger))
	})
	return _c
...
func (_c *GoroutineGoroutine_WithLogger_Call) RunAndReturn(run func(logger kit.CLogger) goroutine.Goroutine) *GoroutineGoroutine_WithLogger_Call {
	_c.Call.Return(run)
	return _c
}

// WithLoggerFn provides a mock function for the type GoroutineGoroutine
func (_mock *GoroutineGoroutine) WithLoggerFn(loggerFn kit.CLoggerFunc) goroutine.Goroutine {
	ret := _mock.Called(loggerFn)
	...
	var r0 goroutine.Goroutine
	if returnFunc, ok := ret.Get(0).(func(kit.CLoggerFunc) goroutine.Goroutine); ok {
		r0 = returnFunc(loggerFn)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(goroutine.Goroutine)
...
func (_c *GoroutineGoroutine_WithLoggerFn_Call) Run(run func(loggerFn kit.CLoggerFunc)) *GoroutineGoroutine_WithLoggerFn_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(kit.CLoggerFunc))
	})
	return _c
...
func (_c *GoroutineGoroutine_WithLoggerFn_Call) RunAndReturn(run func(loggerFn kit.CLoggerFunc) goroutine.Goroutine) *GoroutineGoroutine_WithLoggerFn_Call {
	_c.Call.Return(run)
	return _c
}
