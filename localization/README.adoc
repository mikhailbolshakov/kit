...
[source,go]
----
import "gitlab.com/algmib/kit/localization"
----
...
* PostgreSQL storage via `gitlab.com/algmib/kit/storages/pg`
* Redis caching via `gitlab.com/algmib/kit/storages/redis`
